...
BASE_LLM_PATH=Qwen/Qwen2.5-0.5B-Instruct
VISION_TOWER=OpenGVLab/VideoMamba
PROJECTOR_TYPE=etp
OUTPUT_DIR_PATH=results/pretrain/etp_qwen2point5_0point5B_instrut_video_mamba
...
OUTPUT_DIR_PATH=results/pretrain/etp_qwen2point5_0point5B_instrut_clip_base
...
PRETRAIN_VIDEO_MLP_PATH=results/pretrain/etp_qwen2point5_0point5B_instrut_video_mamba/mm_projector.bin
PRETRAIN_IMAGE_MLP_PATH=results/pretrain/etp_qwen2point5_0point5B_instrut_clip_base/mm_projector.bin
OUTPUT_DIR_PATH=results/mobilevideogpt_finetune_qwen2point5_0point5B
