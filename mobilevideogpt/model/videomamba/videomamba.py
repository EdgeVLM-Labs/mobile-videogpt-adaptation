...
def load_state_dict(pretrained_path, model, ckpt_num_frame, num_frames):
    ...
    if pretrained_path.startswith("hf://"):
        ...
        local_checkpoint_path = pretrained_path

    checkpoint_model = torch.load(local_checkpoint_path, map_location='cpu')
    ...
    if orig_t_size != new_t_size:
        ...
        temporal_pos_embed = temporal_pos_embed.permute(0, 2, 1)
        checkpoint_model['vision_encoder.temporal_pos_embedding'] = temporal_pos_embed
